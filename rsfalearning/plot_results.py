...
new_equality_results = get_results('new_condition3_equality_results_2')
...
sns.lineplot(x='dsfa_state', y='value', hue='variable',
    data=equality_results.melt(id_vars=['dsfa_state'], value_vars=['dsfa_eq', 'new_condition_3_rsfa_eq']))
plt.xlim(0, 200)
plt.ylim(0, 550)
plt.xlabel('Size of minimal DFSA')
plt.ylabel('Number of asked EQs')
...
plt.xlabel('Size of minimal DFSA')
plt.ylabel('Number of asked EQs')
plt.savefig('new_condition3_equality_results_with_old_eq.pdf')
plt.close()

sns.lineplot(x='dsfa_state', y='value', hue='variable',
    data=equality_results.melt(id_vars=['dsfa_state'], value_vars=['dsfa_mq', 'new_condition_3_rsfa_mq']))
plt.xlabel('Size of minimal DFSA')
plt.ylabel('Number of asked MQs')
plt.xlim(0, 200)
plt.ylim(0, 12500)
...
plt.xlim(0, 200)
plt.ylim(0, 12500)
plt.savefig('new_condition3_equality_results_with_old_mq.pdf')
plt.close()


new_int_interval_results = get_results('new_condition3_int_interval_results')
...
sns.lineplot(x='dsfa_state', y='value', hue='variable',
    data=int_interval_results.melt(id_vars=['dsfa_state'], value_vars=['dsfa_eq', 'new_condition_3_rsfa_eq']))
plt.xlim(0, 200)
plt.ylim(0, 750)
plt.xlabel('Size of minimal DFSA')
plt.ylabel('Number of asked EQs')
...
plt.xlabel('Size of minimal DFSA')
plt.ylabel('Number of asked EQs')
plt.savefig('new_condition3_int_interval_results_with_old_eq.pdf')
plt.close()

sns.lineplot(x='dsfa_state', y='value', hue='variable',
    data=int_interval_results.melt(id_vars=['dsfa_state'], value_vars=['dsfa_mq', 'new_condition_3_rsfa_mq']))
plt.xlabel('Size of minimal DFSA')
plt.ylabel('Number of asked MQs')
plt.xlim(0, 200)
plt.ylim(0, 220000)
...
plt.xlim(0, 200)
plt.ylim(0, 220000)
plt.savefig('new_condition3_int_interval_results_with_old_mq.pdf')
plt.close()
